					...
					<div class="latest-post-wrap">
						...
						<div class="single-latest-post row align-items-center">
							<div class="col-lg-5 post-left">
								<div class="feature-img relative">
									...
									<img class="img-fluid" src="asset/page/img/l1.jpg" alt="">
								</div>
								<ul class="tags">
						...
						<div class="single-latest-post row align-items-center">
							<div class="col-lg-5 post-left">
								<div class="feature-img relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="asset/page/img/l2.jpg" alt="">
								</div>
								<ul class="tags">
						...
						<div class="single-latest-post row align-items-center">
							<div class="col-lg-5 post-left">
								<div class="feature-img relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="asset/page/img/l3.jpg" alt="">
								</div>
								<ul class="tags">
						...
						<div class="single-latest-post row align-items-center">
							<div class="col-lg-5 post-left">
								<div class="feature-img relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="asset/page/img/l4.jpg" alt="">
								</div>
								<ul class="tags">
						...
						<div class="single-latest-post row align-items-center">
							<div class="col-lg-5 post-left">
								<div class="feature-img relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="asset/page/img/r1.jpg" alt="">
								</div>
								<ul class="tags">
									<li><a href="#">Science</a></li>
								</ul>
						...
						<div class="single-latest-post row align-items-center">
							<div class="col-lg-5 post-left">
								<div class="feature-img relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="asset/page/img/r2.jpg" alt="">
								</div>
								<ul class="tags">
									<li><a href="#">Travel</a></li>
								</ul>
						...
						<div class="single-latest-post row align-items-center">
							<div class="col-lg-5 post-left">
								<div class="feature-img relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="asset/page/img/r3.jpg" alt="">
								</div>
								<ul class="tags">
									<li><a href="#">Fashion</a></li>
								</ul>
					...
					<div class="sidebars-area">
						<div class="single-sidebar-widget editors-pick-widget">
							...
							<div class="editors-pick-post">
								<div class="feature-img-wrap relative">
									<div class="feature-img relative">
										<div class="overlay overlay-bg"></div>
										<img class="img-fluid" src="asset/page/img/e1.jpg" alt="">
									</div>
									<ul class="tags">
										<li><a href="#">Travel</a></li>
									</ul>
								...
								<div class="post-lists">
									<div class="single-post d-flex flex-row">
										<div class="thumb">
											<img src="asset/page/img/e2.jpg" alt="">
										</div>
										<div class="detail">
									...
									<div class="single-post d-flex flex-row">
										<div class="thumb">
											<img src="asset/page/img/e3.jpg" alt="">
										</div>
										<div class="detail">
									...
									<div class="single-post d-flex flex-row">
										<div class="thumb">
											<img src="asset/page/img/e4.jpg" alt="">
										</div>
										<div class="detail">
						...
						<div class="single-sidebar-widget most-popular-widget">
							...
							<div class="single-list flex-row d-flex">
								<div class="thumb">
									<img src="asset/page/img/m1.jpg" alt="">
								</div>
								<div class="details">
									<a href="image-post.html">
							...
							<div class="single-list flex-row d-flex">
								<div class="thumb">
									<img src="asset/page/img/m2.jpg" alt="">
								</div>
								<div class="details">
									<a href="image-post.html">
							...
							<div class="single-list flex-row d-flex">
								<div class="thumb">
									<img src="asset/page/img/m3.jpg" alt="">
								</div>
								<div class="details">
									<a href="image-post.html">
							...
							<div class="single-list flex-row d-flex">
								<div class="thumb">
									<img src="asset/page/img/m4.jpg" alt="">
								</div>
								<div class="details">
									<a href="image-post.html">
										<h6>5 Tips For Offshore Soft
